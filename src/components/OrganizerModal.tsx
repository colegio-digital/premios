...

{
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/80 backdrop-blur-md animate-fade-in">
      <div className="relative w-full max-w-3xl bg-slate-900 border border-amber-500/30 rounded-2xl shadow-2xl overflow-hidden max-h-[90vh] flex flex-col">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="text-lg font-bold text-white flex items-center gap-2">
                <span>Guía para Organizadores: Configuración de Videos y Nominados</span>
              </h3>
              <p className="text-xs text-slate-400">
                Instrucciones claras para reemplazar <code className="text-amber-300">youtubeId</code> y datos de las 14 categorías
              </p>
            </div>
          </div>
        ...
        <div className="p-6 overflow-y-auto space-y-6 text-sm text-slate-300">
          ...
          <div className="p-4 rounded-xl bg-slate-950/80 border border-slate-800">
            ...
            <p className="text-xs text-slate-300 leading-relaxed">
              ...
              <br />
              <code className="text-amber-300 bg-slate-900 px-2 py-1 rounded mt-2 inline-block font-mono border border-slate-700">
          ...
          <div className="p-4 rounded-xl bg-slate-950/80 border border-slate-800">
            ...
            <p className="text-xs text-slate-300 leading-relaxed mb-3">
              El <code className="text-amber-300 font-mono">youtubeId</code> es el código de 11 caracteres que aparece al final de la URL de cualquier video de YouTube:
            </p>
            <ul className="text-xs space-y-1.5 font-mono text-slate-400 bg-slate-900 p-3 rounded-lg border border-slate-800">
              <li>• URL: https://www.youtube.com/watch?v=<span className="text-amber-300 font-bold underline">fmErhmOOLXU</span></li>
              <li>• youtubeId actual: <span className="text-amber-300 font-bold">&apos;fmErhmOOLXU&apos;</span></li>
            </ul>
          </div>
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between">
              <span className="font-bold text-white text-xs uppercase tracking-wider text-amber-400">
                Ejemplo de Estructura para {targetCategory?.title}:
              </span>
              <button
                onClick={handleCopySnippet}
                className="flex items-center gap-1.5 px-3 py-1 rounded bg-slate-800 hover:bg-slate-700 text-xs text-amber-300 font-medium transition-colors border border-slate-700"
              >
                {copiedSnippet ? (
                  <>
            ...
            <pre className="p-4 rounded-xl bg-slate-950 border border-slate-800 text-xs font-mono text-amber-200/90 overflow-x-auto">
              {codeExampleSnippet}
            </pre>
          </div>
